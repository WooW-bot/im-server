...
/**
 * 好友申请控制器 参考腾讯云文档: https://cloud.tencent.com/document/product/269/1569
 *
 * @author Parker
 * @date 12/9/25
 */
...
public class ImFriendShipRequestController {
  ...
  public ResponseVO approveFriendRequest(@RequestBody @Validated ApproveFriendRequestReq req,
      @RequestHeader("appId") Integer appId, String identifier) {
    req.setAppId(appId);
  ...
  /**
   * 获取好友申请 参考: https://cloud.tencent.com/document/product/269/1647
   *
  ...
  public ResponseVO getFriendRequest(@RequestBody @Validated GetFriendShipRequestReq req,
      @RequestHeader("appId") Integer appId) {
    req.setAppId(appId);
   ...
   * @return ResponseVO
   */
  @RequestMapping("/syncFriendShipRequestList")
  public ResponseVO syncFriendShipRequestList(@RequestBody @Validated SyncRequest req,
      @RequestHeader("appId") Integer appId, String identifier) {
    req.setAppId(appId);
    req.setOperator(identifier);
    return imFriendShipRequestService.syncFriendshipRequestList(req);
  }
}
